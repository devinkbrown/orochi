...
//!
//! `tsumugi_handshake` provides the raw `Initiator`/`Responder` state machines;
...
const hs = @import("tsumugi_handshake.zig");
...
/// Deterministic randomness for handshake KEM (mirrors tsumugi_handshake tests).
