...
4. Reconcile and validate `/home/kain/orochi-run/orochi.local.toml` and `/home/trev/orochi-run/orochi.ircxus.toml` against the new reference config before touching either service.
