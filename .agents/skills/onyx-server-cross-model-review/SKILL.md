---
name: onyx-server-cross-model-review
description: Run bounded, grounded, independent Claude review of Onyx Server changes. Use for fresh mechanical, integration, security, Helix, mesh, crypto, token, replay, or release-critical review without granting Claude write access.
---
