...
//! Native cadence negative-ack helpers for Undertow media frames.
//!
//! This module keys retransmission and gap tracking by `cadence_frame`
...
//!
//!     zig test src/substrate/cadence_nack.zig
