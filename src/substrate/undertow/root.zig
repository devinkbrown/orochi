...
//! UNDERTOW math substrate: logical clocks, delta-state CRDTs, and Merkle
//! anti-entropy — the building blocks of the UNDERTOW mesh state model.
...
pub const concord = @import("concord.zig");
pub const concord_props = @import("concord_props.zig");
pub const concord_sync = @import("concord_sync.zig");
...
pub const ripple_dst = @import("ripple_dst.zig");
