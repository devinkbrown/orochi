...
pub const dtls_peer_verify = @import("dtls_peer_verify.zig");
...
pub const mooring = @import("mooring.zig");
pub const mooring_props = @import("mooring_props.zig");
...
pub const ripple_report = @import("ripple_report.zig");
...
pub const s2s_protocol = "UNDERTOW";

/// Transport security wrapper for post-auth mesh frames.
pub const transport_security = "MOORING";
