...
pub const module = registry.Module{
    ...
    .commands = &.{
        ...
        .{ .name = "FORCEPART", .min_params = 2, .access = .oper, .handler = forceAction },
        .{ .name = "FORCETOPIC", .min_params = 2, .access = .oper, .handler = forceAction },
        .{ .name = "CLEAR", .min_params = 1, .access = .registered, .handler = clear },
        .{ .name = "TEMPMODE", .min_params = 1, .access = .registered, .handler = tempmode },
        .{ .name = "CLONES", .min_params = 0, .access = .oper, .handler = clones },
        .{ .name = "SEEN", .min_params = 1, .access = .registered, .handler = seen },
    },
};
