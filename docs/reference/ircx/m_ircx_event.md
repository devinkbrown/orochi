# m_ircx_event — Provides IRCX EVENT command for oper event monitoring
> Source-verified module reference for `m_ircx_event`.

## Overview
`m_ircx_event` is a C module implemented in `modules/m_ircx_event.c`. Provides IRCX EVENT command for oper event monitoring.
