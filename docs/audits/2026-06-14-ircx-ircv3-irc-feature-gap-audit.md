...
- **Documentation Drift** — largely already corrected: `_index.md` GROUP described + CERTLIST/CERTDEL present; LISTX/PROP/ACCESS planning marks updated (doc 21). Residual prose drift in `CONFORMANCE.md`/`caps.md`/`numerics.md` remains a lower-priority cleanup.
