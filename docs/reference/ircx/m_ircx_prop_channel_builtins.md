# m_ircx_prop_channel_builtins — Provides IRCX built-in channel properties (OID, NAME, CREATION, TOPIC, MEMBERCOUNT, MEMBERKEY, MEMBERLIMIT, PICS, LAG, CLIENT)
> Source-verified module reference for `m_ircx_prop_channel_builtins`.

## Overview
`m_ircx_prop_channel_builtins` is a C module implemented in `modules/m_ircx_prop_channel_builtins.c`. Provides IRCX built-in channel properties (OID, NAME, CREATION, TOPIC, MEMBERCOUNT, MEMBERKEY, MEMBERLIMIT, PICS, LAG, CLIENT).
