...
/// Human version string including the build's git revision, e.g.
/// "0.0.1-dev (a1b2c3d)". Used in the boot banner and VERSION reply.
pub const version_full = version ++ " (" ++ git_commit ++ ")";
