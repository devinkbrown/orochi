---
name: orochi-agent-toolkit
description: Audit, evolve, and validate Orochi's Codex and Claude engineering toolkit. Use when adding or updating project agents, skills, model or effort routing, delegation rules, review launchers, worktree strategy, roster validation, or cross-model workflows.
---

# Maintain the Orochi agent toolkit
