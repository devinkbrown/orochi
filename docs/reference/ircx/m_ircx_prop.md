# m_ircx_prop — Provides IRCX PROP command
> Source-verified module reference for `m_ircx_prop`.

## Overview
`m_ircx_prop` is a C module implemented in `modules/m_ircx_prop.c`. Provides IRCX PROP command.
