# m_ircx_prop_entity_user — IRCX PROP support for users

_Source-verified module reference for `m_ircx_prop_entity_user`, which provides IRCX PROP support for users._

## Overview

`m_ircx_prop_entity_user` is a C module implemented in `modules/m_ircx_prop_entity_user.c`. It provides IRCX PROP support for users.
